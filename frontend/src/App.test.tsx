...
describe('GrantLink Frontend Unit Tests', () => {
  beforeEach(() => {
    ...
    gProcess.env.VITE_GRANT_REGISTRY_CONTRACT = 'CCREATEGRANTSREGISTRY11111122222233333344444455555566666';
    gProcess.env.VITE_GRANT_APPLICATION_CONTRACT = 'CAPPLICATIONCONTRACT111111222222333333444444555555666666';
    gProcess.env.VITE_GRANT_ESCROW_CONTRACT = 'CESCROWCONTRACT11111122222233333344444455555566666677777';
    gProcess.env.VITE_NETWORK_PASSPHRASE = 'Test SDF Network ; September 2015';
    
    vi.stubEnv('VITE_RPC_URL', 'https://mock-rpc.stellar.org');
    vi.stubEnv('VITE_GRANT_REGISTRY_CONTRACT', 'CCREATEGRANTSREGISTRY11111122222233333344444455555566666');
    vi.stubEnv('VITE_GRANT_APPLICATION_CONTRACT', 'CAPPLICATIONCONTRACT111111222222333333444444555555666666');
    vi.stubEnv('VITE_GRANT_ESCROW_CONTRACT', 'CESCROWCONTRACT11111122222233333344444455555566666677777');
